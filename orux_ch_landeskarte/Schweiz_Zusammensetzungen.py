...
for fSwissgridKarte, iKarteNr, strKarteName in listZusammensetzungen:
  map = programm.OruxMap('CH_%d_%s' % (iKarteNr, strKarteName), strTopFolder='Schweiz_Zusammensetzungen')
